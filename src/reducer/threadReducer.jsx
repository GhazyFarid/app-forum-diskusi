...
export const createThread = createAsyncThunk(
  ...
  async (payload, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error.response?.data?.message || 'Create thread failed');
    }
  },
);
...
export const getAllThreads = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error.response?.data?.message || 'Fetch threads failed');
    }
  },
);
...
export const getThreadById = createAsyncThunk(
  ...
  async (threadId, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error.response?.data?.message || 'Fetch thread detail failed');
    }
  },
);
